...
(
	...
	BEGIN CATCH SELECT 0 AS [success], 'UNABLE_TO_PROMOTE' AS [message] RETURN END CATCH
	SELECT 1 AS [success], 'PROMOTED_TO_TRAINER' AS [message] RETURN
END 
GO
...
(
	...
	END TRY
	BEGIN CATCH
		SELECT 0 AS [success], 'UNABLE_TO_ADD_SPECIALISATION' AS [message]
		RETURN
	END CATCH
	SELECT 1 AS [success], 'SPECIALISATION_ADDED' AS [message]
END
GO